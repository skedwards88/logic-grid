...
function getClueAboutNumber(numberIndex, possibleNumbers) {
  ...
  const altNumbers = [...possibleNumbers.slice(0,numberIndex), ...possibleNumbers.slice(numberIndex+1,possibleNumbers.length)];
...
function getClueAboutWord(wordIndex, possibleWords) {
  ...
  const altWords = [...possibleWords.slice(0,wordIndex), ...possibleWords.slice(wordIndex+1,possibleWords.length)];

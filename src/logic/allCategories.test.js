...
describe("allCategories: tests per scenario", () => {
  allCategories.forEach((scenario, scenarioIndex) => {
    ...
    scenario.forEach((category, categoryIndex) => {
      test(`Scenario ${scenarioIndex} category ${categoryIndex}, about '${category.descriptionTemplates.description(
        "${value}",
      )}' has values that are unique within each category`, () => {
        expect(arrayValuesAreUniqueQ(category.values)).toBe(true);
      });

      test(`Scenario ${scenarioIndex} category ${categoryIndex}, about '${category.descriptionTemplates.description(
        "${value}",
      )}' has at least 5 values`, () => {
        expect(category.values.length).toBeGreaterThanOrEqual(5);
      });

      test(`Scenario ${scenarioIndex} category ${categoryIndex}, about '${category.descriptionTemplates.description(
        "${value}",
      )}' uses the value in every description`, () => {
        for (const template in category.descriptionTemplates) {
          if (template === "verb") continue;
          const generatedDescription =
            category.descriptionTemplates[template]("X_TEST_VALUE");
      ...
      test(`Scenario ${scenarioIndex} category ${categoryIndex}, about '${category.descriptionTemplates.description(
        "${value}",
      )}' has the expected description templates`, () => {
  ...
  test("A sampling of clue text", () => {
    ...
    allCategories.forEach((scenario) => {
      scenario.forEach((categoryA, indexA) => {
        ...
        scenario.forEach((categoryB, indexB) => {
          ...
          const numericSomeDescription = templatesB.diffGreaterDescription(
            `at least ${minimumNumericDiff}`,
          );
    ...
    expect(descriptions).toMatchInlineSnapshot(`
      [
        ...
        "the person using red ink scored at least 5 points higher than the person whose grade was 100.",
        ...
        "Aaron scored at least 5 points higher than the person whose grade was 100.",
        ...
        "the person who wrote about dogs scored at least 5 points higher than the person whose grade was 100.",
        ...
        "the person who snacks at 1 o'clock takes at least 5 minutes more than the person who takes 10 minutes.",
        ...
        "Aaron takes at least 5 minutes more than the person who takes 10 minutes.",
        ...
        "the person with the red cup takes at least 5 minutes more than the person who takes 10 minutes.",
        ...
        "the person who drinks tea takes at least 5 minutes more than the person who takes 10 minutes.",
        ...
        "the person who eats the apple takes at least 5 minutes more than the person who takes 10 minutes.",
        ...
        "the jewelry with 1 stones cost at least 50 dollars more than the jewelry that cost 100 dollars.",
        ...
        "Aaron's jewelry cost at least 50 dollars more than the jewelry that cost 100 dollars.",
        ...
        "the jewelry with the ruby cost at least 50 dollars more than the jewelry that cost 100 dollars.",
        ...
        "the necklace cost at least 50 dollars more than the jewelry that cost 100 dollars.",
        ...
        "the sandwich on french bread costs at least 1 dollars more than the sandwich that cost $7.",
        ...
        "the eggplant sandwich costs at least 1 dollars more than the sandwich that cost $7.",
        ...
        "the sandwich flavored with mayo costs at least 1 dollars more than the sandwich that cost $7.",
        ...
        "the historian who studies disease studies the period at least 1 centuries later than the historian who studies the 14th century.",
        ...
        "Aaron studies the period at least 1 centuries later than the historian who studies the 14th century.",
        ...
        "the historian who studies at Stanford studies the period at least 1 centuries later than the historian who studies the 14th century.",
        ...
        "Ace has at least 2 more legs than the pet with 0 legs.",
        ...
        "the pet that likes sleeping has at least 2 more legs than the pet with 0 legs.",
        ...
        "the pet in the metal cage has at least 2 more legs than the pet with 0 legs.",
        ...
        "the clown with the red hair rides on at least 1 more wheels than the clown on 0 wheels.",
        ...
        "the clown that juggles rides on at least 1 more wheels than the clown on 0 wheels.",
        ...
        "the clown with the flower rides on at least 1 more wheels than the clown on 0 wheels.",
        ...
        "the dancer that likes tango danced at least 1 more hours than the dancer that danced until 7 PM.",
        ...
        "the dancer that likes tango danced at least 5 more songs than the dancer that danced 15 songs.",
        ...
        "the dancer that danced until 7 PM danced at least 5 more songs than the dancer that danced 15 songs.",
        ...
        "the dancer that danced 15 songs danced at least 1 more hours than the dancer that danced until 7 PM.",
        ...
        "the dancer that likes pop music danced at least 1 more hours than the dancer that danced until 7 PM.",
        ...
        "the dancer that likes pop music danced at least 5 more songs than the dancer that danced 15 songs.",
        ...
        "the mystery novel has at least 50 more pages than the 100 page novel.",
        ...
        "the mystery novel was published at least 5 years earlier than the novel published in 2020.",
        ...
        "the 100 page novel was published at least 5 years earlier than the novel published in 2020.",
        ...
        "the novel published in 2020 has at least 50 more pages than the 100 page novel.",
        ...
        "the novel written by Smith has at least 50 more pages than the 100 page novel.",
        ...
        "the novel written by Smith was published at least 5 years earlier than the novel published in 2020.",
        ...
        "Aaron wore their cast for at least 1 more weeks than the patient who wore their cast for 4 weeks.",
        ...
        "the patient with the red cast wore their cast for at least 1 more weeks than the patient who wore their cast for 4 weeks.",
        ...
        "the patient with the broken foot wore their cast for at least 1 more weeks than the patient who wore their cast for 4 weeks.",
